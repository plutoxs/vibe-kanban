...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::project_repo::ProjectRepoWithRepo::decl(),
        db::models::project_repo::ProjectRepoInput::decl(),
        ...
        server::routes::repo::ScanDirectoryRequest::decl(),
        server::routes::repo::ScanDirectoryResponse::decl(),
        server::routes::repo::ScannedRepo::decl(),
        server::routes::repo::BulkRegisterReposRequest::decl(),
        server::routes::repo::BulkRegisterReposResponse::decl(),
        server::routes::repo::BulkRegisterFailure::decl(),
        server::routes::projects::SetProjectReposRequest::decl(),
